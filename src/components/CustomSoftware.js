...
export default function CustomSoftware({ setValue, setSelectedIdx }) {
        ...
        <Hidden mdDown>
          <Grid item className={classes.arrowContainer}>
            <IconButton
              ...
              to="/mobileapps"
            >
              <img src={forwardArrow} alt="Forward to Mobile App Page" />
            </IconButton>
          </Grid>
        </Hidden>
        <Grid
          ...
          direction="row"
          justify="center"
          style={{ marginTop: "7em", marginBottom: "10em" }}
          spacing={matchesMD ? 10 : undefined}
        >
          <Grid
            item
            container
